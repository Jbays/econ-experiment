// divides subjects into equal groups, "groupSize" subjects per group.  if there aren't enough subjects to fill out all groups, the last group will have.  the remaining subjects
...
// update the subject table when new progress messages are received, showing the subject's current period, group, and subperiod, 
function update(grid) {
  console.log('from update.  this is grid',grid);
